...
// This is a direct copy of ModelIronGolem
@SideOnly(Side.CLIENT)
public class ModelMCTGTroll extends ModelBase
{
    ...
    public ModelMCTGTroll()
    {
        this(0.0F);
    }

    public ModelMCTGTroll(float p_i1161_1_)
    {
        this(p_i1161_1_, -7.0F);
    }

    public ModelMCTGTroll(float p_i46362_1_, float p_i46362_2_)
    {
        short short1 = 128;
        short short2 = 128;
    ...
    {
        EntityMCTGTroll entity = (EntityMCTGTroll)p_78086_1_;

...
public class EntityMCTGAIWizardAttack extends EntityAIBase
{
    ...
    public EntityMCTGAIWizardAttack(IRangedAttackMob p_i1649_1_, double p_i1649_2_, int p_i1649_4_, float p_i1649_5_)
    {
        this(p_i1649_1_, p_i1649_2_, p_i1649_4_, p_i1649_4_, p_i1649_5_);
    }

    public EntityMCTGAIWizardAttack(IRangedAttackMob p_i1650_1_, double p_i1650_2_, int p_i1650_4_, int p_i1650_5_, float p_i1650_6_)
    {
    ...
    public boolean shouldExecute()
    {
        ...
        //System.out.println("Target " + entitylivingbase);
    ...
    {
    	boolean flagshould = this.shouldExecute(); 
    	boolean flagpath = !this.entityHost.getNavigator().noPath();
    	//System.out.println("Continue should = " + flagshould + "; path = " + flagpath);
        return flagshould || flagpath;
    }
    ...
    public void updateTask()
    {
        ...
        //System.out.println(d0 + " " + flag + " " + this.field_75318_f);
        ...
        float f;
        //System.out.println("Ranged attack time " + this.rangedAttackTime);
        if (--this.rangedAttackTime == 0)
        {
        	//System.out.println("Timer zero");
